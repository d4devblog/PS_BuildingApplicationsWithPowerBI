...
var ReportEmbedding = /** @class */ (function () {
    ...
    ReportEmbedding.prototype.embedReport = function (reportName, hostContainer, showMobileLayout) {
        var _this = this;
        this.getReportEmbedModel(reportName)
            ...
            return _this.buildReportEmbedConfiguration(responseContent, showMobileLayout);
        })
    ...
    ReportEmbedding.prototype.buildReportEmbedConfiguration = function (embedModel, showMobileLayout) {
        var layoutSettings = {
    ...
    ReportEmbedding.prototype.runEmbedding = function (reportConfiguration, hostContainer, reportName, showMobileLayout) {
        ...
        report.on("loaded", function () {
            ...
            _this.setContainerHeight(report, hostContainer, showMobileLayout);
        });
    };
    ...
    ReportEmbedding.prototype.setContainerHeight = function (report, hostContainer, showMobileLayout) {
        report.getPages().then(function (p) {
