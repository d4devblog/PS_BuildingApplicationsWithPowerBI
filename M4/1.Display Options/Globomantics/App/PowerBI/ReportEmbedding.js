...
var ReportEmbedding = /** @class */ (function () {
    ...
    ReportEmbedding.prototype.embedReport = function (reportName, hostContainer) {
        ...
        this.getReportEmbedModel(reportName)
            ...
            return _this.buildReportEmbedConfiguration(responseContent);
        })
    ...
    ReportEmbedding.prototype.runEmbedding = function (reportConfiguration, hostContainer, reportName) {
        var _this = this;
        var report = this.pbiService.embed(hostContainer, reportConfiguration);
        report.off("loaded");
        report.on("loaded", function () {
            _this.handleTokenExpiration(report, reportName);
            _this.setContainerHeight(report, hostContainer);
        });
    };
    ...
    ReportEmbedding.prototype.setContainerHeight = function (report, hostContainer) {
