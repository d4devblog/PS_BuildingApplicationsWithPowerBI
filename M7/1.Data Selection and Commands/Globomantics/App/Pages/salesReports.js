...
function SalesReports(props) {
    ...
    return (react_1.default.createElement(Paper_1.default, { className: classes.paper },
        react_1.default.createElement(Box_1.default, { p: 3, className: classes.reportContainer },
            react_1.default.createElement(PowerBIReport_1.default, __assign({ reportName: "sales_v5", buttonFunctions: buttonFunctions, filterConfiguration: filterConfig, reportCommands: commands, externalActions: externalActions }, props)))));
}
