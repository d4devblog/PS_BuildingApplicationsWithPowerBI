...
function PowerBIReport(props) {
    ...
    var reportFilters = (react_1.default.createElement(ReportFilters_1.default, __assign({ applyFilterCallback: filterCallback, filterConfiguration: props.filterConfiguration }, props)));
